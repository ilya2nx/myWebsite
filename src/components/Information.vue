<template>
  <div class="card">
    ...
    <br />
    <h2 class="text-center">Соцсети</h2>
    <p><a href="https://vk.com/ilya2nx" target="_blank">Вконтакте</a></p>
    <p><a href="https://www.instagram.com/ilya2nx/" target="_blank">Инстаграм</a></p>
  </div>
  <div class="card">
    <h2 class="text-center">Для связи</h2>
    <p class="bold icon-email"> ilyanovikov2n@gmail.com </p>
    <p class="bold icon-phone"> +7-910-621-95-69 </p>
  </div>
</template>
